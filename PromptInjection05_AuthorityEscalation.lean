...
theorem criticalAuthority_nonneg
  ...
  apply csInf_le_of_le (OrderBot.bddBelow _) (Classical.choice h_ne).2
  intro ⟨h_eq, _⟩
  sorry -- placeholder: this direction needs an auxiliary bound
  -- We take a cleaner approach below using Real-valued slices.
